...
inline fun ViewManager.button(theme: Int = 0, text: CharSequence?): android.widget.Button {
    return ankoView(`$$Anko$Factories$Sdk23View`.BUTTON, theme) {
        setText(text)
    }
}
inline fun ViewManager.button(theme: Int = 0, text: CharSequence?, init: android.widget.Button.() -> Unit): android.widget.Button {
    return ankoView(`$$Anko$Factories$Sdk23View`.BUTTON, theme) {
        init()
        setText(text)
    }
...
inline fun ViewManager.button(theme: Int = 0, text: Int): android.widget.Button {
    return ankoView(`$$Anko$Factories$Sdk23View`.BUTTON, theme) {
        setText(text)
    }
}
inline fun ViewManager.button(theme: Int = 0, text: Int, init: android.widget.Button.() -> Unit): android.widget.Button {
    return ankoView(`$$Anko$Factories$Sdk23View`.BUTTON, theme) {
        init()
        setText(text)
    }
...
inline fun ViewManager.checkBox(theme: Int = 0, text: CharSequence?): android.widget.CheckBox {
    return ankoView(`$$Anko$Factories$Sdk23View`.CHECK_BOX, theme) {
        setText(text)
    }
}
inline fun ViewManager.checkBox(theme: Int = 0, text: CharSequence?, init: android.widget.CheckBox.() -> Unit): android.widget.CheckBox {
    return ankoView(`$$Anko$Factories$Sdk23View`.CHECK_BOX, theme) {
        init()
        setText(text)
    }
...
inline fun ViewManager.checkBox(theme: Int = 0, text: Int): android.widget.CheckBox {
    return ankoView(`$$Anko$Factories$Sdk23View`.CHECK_BOX, theme) {
        setText(text)
    }
}
inline fun ViewManager.checkBox(theme: Int = 0, text: Int, init: android.widget.CheckBox.() -> Unit): android.widget.CheckBox {
    return ankoView(`$$Anko$Factories$Sdk23View`.CHECK_BOX, theme) {
        init()
        setText(text)
    }
...
inline fun ViewManager.checkBox(theme: Int = 0, text: CharSequence?, checked: Boolean): android.widget.CheckBox {
    return ankoView(`$$Anko$Factories$Sdk23View`.CHECK_BOX, theme) {
        setText(text)
        setChecked(checked)
    }
}
inline fun ViewManager.checkBox(theme: Int = 0, text: CharSequence?, checked: Boolean, init: android.widget.CheckBox.() -> Unit): android.widget.CheckBox {
    return ankoView(`$$Anko$Factories$Sdk23View`.CHECK_BOX, theme) {
        init()
        setText(text)
        setChecked(checked)
...
inline fun ViewManager.checkBox(theme: Int = 0, text: Int, checked: Boolean): android.widget.CheckBox {
    return ankoView(`$$Anko$Factories$Sdk23View`.CHECK_BOX, theme) {
        setText(text)
        setChecked(checked)
    }
}
inline fun ViewManager.checkBox(theme: Int = 0, text: Int, checked: Boolean, init: android.widget.CheckBox.() -> Unit): android.widget.CheckBox {
    return ankoView(`$$Anko$Factories$Sdk23View`.CHECK_BOX, theme) {
        init()
        setText(text)
        setChecked(checked)
...
inline fun ViewManager.editText(theme: Int = 0, text: CharSequence?): android.widget.EditText {
    return ankoView(`$$Anko$Factories$Sdk23View`.EDIT_TEXT, theme) {
        setText(text)
    }
}
inline fun ViewManager.editText(theme: Int = 0, text: CharSequence?, init: android.widget.EditText.() -> Unit): android.widget.EditText {
    return ankoView(`$$Anko$Factories$Sdk23View`.EDIT_TEXT, theme) {
        init()
        setText(text)
    }
...
inline fun ViewManager.editText(theme: Int = 0, text: Int): android.widget.EditText {
    return ankoView(`$$Anko$Factories$Sdk23View`.EDIT_TEXT, theme) {
        setText(text)
    }
}
inline fun ViewManager.editText(theme: Int = 0, text: Int, init: android.widget.EditText.() -> Unit): android.widget.EditText {
    return ankoView(`$$Anko$Factories$Sdk23View`.EDIT_TEXT, theme) {
        init()
        setText(text)
    }
...
inline fun ViewManager.imageButton(theme: Int = 0, imageDrawable: android.graphics.drawable.Drawable?): android.widget.ImageButton {
    return ankoView(`$$Anko$Factories$Sdk23View`.IMAGE_BUTTON, theme) {
        setImageDrawable(imageDrawable)
    }
}
inline fun ViewManager.imageButton(theme: Int = 0, imageDrawable: android.graphics.drawable.Drawable?, init: android.widget.ImageButton.() -> Unit): android.widget.ImageButton {
    return ankoView(`$$Anko$Factories$Sdk23View`.IMAGE_BUTTON, theme) {
        init()
        setImageDrawable(imageDrawable)
    }
...
inline fun ViewManager.imageButton(theme: Int = 0, imageResource: Int): android.widget.ImageButton {
    return ankoView(`$$Anko$Factories$Sdk23View`.IMAGE_BUTTON, theme) {
        setImageResource(imageResource)
    }
}
inline fun ViewManager.imageButton(theme: Int = 0, imageResource: Int, init: android.widget.ImageButton.() -> Unit): android.widget.ImageButton {
    return ankoView(`$$Anko$Factories$Sdk23View`.IMAGE_BUTTON, theme) {
        init()
        setImageResource(imageResource)
    }
...
inline fun ViewManager.imageView(theme: Int = 0, imageDrawable: android.graphics.drawable.Drawable?): android.widget.ImageView {
    return ankoView(`$$Anko$Factories$Sdk23View`.IMAGE_VIEW, theme) {
        setImageDrawable(imageDrawable)
    }
}
inline fun ViewManager.imageView(theme: Int = 0, imageDrawable: android.graphics.drawable.Drawable?, init: android.widget.ImageView.() -> Unit): android.widget.ImageView {
    return ankoView(`$$Anko$Factories$Sdk23View`.IMAGE_VIEW, theme) {
        init()
        setImageDrawable(imageDrawable)
    }
...
inline fun ViewManager.imageView(theme: Int = 0, imageResource: Int): android.widget.ImageView {
    return ankoView(`$$Anko$Factories$Sdk23View`.IMAGE_VIEW, theme) {
        setImageResource(imageResource)
    }
}
inline fun ViewManager.imageView(theme: Int = 0, imageResource: Int, init: android.widget.ImageView.() -> Unit): android.widget.ImageView {
    return ankoView(`$$Anko$Factories$Sdk23View`.IMAGE_VIEW, theme) {
        init()
        setImageResource(imageResource)
    }
...
inline fun ViewManager.textView(theme: Int = 0, text: CharSequence?): android.widget.TextView {
    return ankoView(`$$Anko$Factories$Sdk23View`.TEXT_VIEW, theme) {
        setText(text)
    }
}
inline fun ViewManager.textView(theme: Int = 0, text: CharSequence?, init: android.widget.TextView.() -> Unit): android.widget.TextView {
    return ankoView(`$$Anko$Factories$Sdk23View`.TEXT_VIEW, theme) {
        init()
        setText(text)
    }
...
inline fun ViewManager.textView(theme: Int = 0, text: Int): android.widget.TextView {
    return ankoView(`$$Anko$Factories$Sdk23View`.TEXT_VIEW, theme) {
        setText(text)
    }
}
inline fun ViewManager.textView(theme: Int = 0, text: Int, init: android.widget.TextView.() -> Unit): android.widget.TextView {
    return ankoView(`$$Anko$Factories$Sdk23View`.TEXT_VIEW, theme) {
        init()
        setText(text)
    }
...
inline fun ViewManager.webView(theme: Int = 0, init: _WebView.() -> Unit): android.webkit.WebView {
    return ankoView(`$$Anko$Factories$Sdk23ViewGroup`.WEB_VIEW, theme) { init() }
}
